    ...
    <>
      ...
      <section className="bg-flush">
        <div className="container split">
          ...
          <Reveal dir="right" className="split-media"><Tile swatch="p6" bgImage="https://images.unsplash.com/photo-1509062522246-3755977927d7?auto=format&fit=crop&w=800&q=80" alt="Students collaborating and sitting in a modern high school study area" className="frame" /></Reveal>
        </div>
      </section>

      <section className="bg-tint">
        <div className="container split">
          <Reveal dir="left" className="split-media"><Tile swatch="p1" bgImage="https://images.unsplash.com/photo-1562774053-701939374585?auto=format&fit=crop&w=800&q=80" alt="Learner studying science elements and writing notes in an educational workshop" className="frame" /></Reveal>
          <Reveal className="split-body">
      ...
      <section className="bg-tint">
        <div className="container split">
          ...
          <Reveal dir="right" className="split-media"><Tile swatch="p4" bgImage="https://images.unsplash.com/photo-1521587760476-6c12a4b040da?auto=format&fit=crop&w=800&q=80" alt="Row of textbooks and study materials ready for a clean curriculum overview" className="frame" /></Reveal>
        </div>
      </section>
    </>
  );
